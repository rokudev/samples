...
function onTestItemSelected(msg as Object)
    ...
    testConfig = {adURL: cont.adURL, title: cont.title, type: "vod", mediaURL: cont.mediaURL}
    if cont.live then testConfig["type"] = "live"
    ' ~~~ Optional, use Brightcove PlaybackAPI
    if cont.masterURL <> invalid then testConfig["masterURL"] = cont.masterURL
